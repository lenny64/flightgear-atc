...
</span> <a href="./edit_event.php5?eventId=<?php echo $Event->id;?>" class="event_button_edit">Edit event</a>
...
<?php include('./include/show_flightplans.php5'); ?>

<!-- FLIGHTPLAN FILLING -->
<div class="file_flightplan" id="file_flightplan<?php echo $Event->id;?>" method="post" action="./index.php5">
    <!-- Blue top left arrow -->
