...
<?php
    ...
    if (isset($_POST['specialEventId']) AND isset($_POST['specialEventParticipate']) AND isset($_POST['participationCallsign']))
    {
        ...
        {
            $specialEventId = mysql_real_escape_string(htmlspecialchars($_POST['specialEventId']));
            $participation = mysql_real_escape_string(htmlspecialchars($_POST['specialEventParticipate']));
            $callsign = mysql_real_escape_string(htmlspecialchars($_POST['participationCallsign']));
