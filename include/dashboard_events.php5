...
{
  include './include/dashboard_oneClickEvent.php5';
}
?>
...
{
  ?>
  <div class='alert alert-info'>Welcome on your dashboard. You can create events directly <a href="./index.php5">from the home page</a>.</div>
  <?php
}
