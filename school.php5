                ...
                ?>
                    <div class="row">
                        <div class="col-md-5 bg-info">
                            ...
                            <p>
                                <a href="./download.php5?file=<?php echo $flightplanSuggestion['docsLink'];?>" target="_blank" class="btn btn-info btn-sm"><img src="./img/logo_pdf.png" width="25"/> Flight plan Suggestion document</a>
                            </p>
                            <p>
                        ...
                        <div class="col-md-7">
                            <form role="form" class="" action="./index.php5" method="post">
