...
if (isset($_GET['flightplanId']) AND $_GET['flightplanId'] != NULL)
{
    ...
    <div class="alert alert-info">
        ...
        <form role="form" method="post" class="" action="./edit_flightplan.php?flightplanId=<?php echo $flightplanId;?>" <?php if (isset($_GET['form_newSession'])) echo "style='display:none;'";?>>
