...
<h3>Regularly controlled area</h3>

<p class="normal_content">
	European airports are one of the most controlled, and provide a great regular ATC service.
	<br/>
	...
	<ul>
		...
		<li><b>EDDP (Leipzig/Halle)</b></li>
			...
			- <a href='http://wiki.flightgear.org/EDDP' target='_blank'>Get an overview here</a></li>
