...
{ ?>
    ...
    <form action="./dev2014_01_13.php5" method="get">
        ...
        Syntax : http://flightgear-atc.alwaysdata.net/dev2014_01_13.php5?editFlightplan&email=<input type="text" name="email" value="email" size="8" disabled/>&password=<input type="password" name="password" value="password" size="8" disabled/>&flightplanId=<input type="text" name="flightplanId" value="" size="3"/>
    ...
    <form action="./dev2014_01_13.php5" method="get">
        ...
        Syntax : http://flightgear-atc.alwaysdata.net/dev2014_01_13.php5?setVar&email=<input type="text" name="email" value="email" size="8" disabled/>&password=<input type="password" name="password" value="password" size="8" disabled/>&flightplanId=<input type="text" name="flightplanId" size="3"/>&variable=<input type="text" name="variable" size="5"/>&value=<input type="text" name="value" size="3"/>
        <br/>
        <input type="submit" value="OK"/>
    </form>
