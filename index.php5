...
echo "<h4 style='padding: 1%; background-color: #71c837; border: solid 1px #71c837; display: inline-block; margin-left: 40px; '><a href='./V4/index.php5' style='color: #fff;'>What will you expect in the next website version ?</a></h4>";
